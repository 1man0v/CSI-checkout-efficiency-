...
const I18N = {
  ru: {
    ...
    "chart.hourly_load_overload_note": "Избыток открытых POS (больше, чем нужно под остаток спроса после КСО) в часы:",
  ...
  en: {
    ...
    "chart.hourly_load_overload_note": "Excess open POS lanes (more than needed for the residual demand after SCO) during:",
